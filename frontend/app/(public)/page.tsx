...
const FAQ = [
  ...
  [
    ...
    "Нет. Это кабинет подготовки с планом, тренировками и контролем прогресса.",
  ],
  [
  ...
  [
    "Как защищены данные?",
    "Данные используются только для подготовки и не публикуются.",
  ],
  [
    "Можно ли пройти подготовку полностью онлайн?",
    "Да, все этапы доступны онлайн в любое время.",
  ],
  [
    "Какие ситуации покрываются?",
    "Алкоголь, Наркотики, Штрафные пункты, Поведение и смежные случаи.",
  ],
  [
    "Если уже был опыт подготовки ранее, это поможет?",
    "Да. Вы увидите пробелы и получите понятный план их закрытия.",
  ],
] as const;
      ...
      <section className="section" id="hero">
        <div className="premium-hero card pad premium-hero-compact">
          ...
          <p className="lead mt-12 premium-hero-sub">
            Помогаем пройти путь подготовки последовательно: от диагностики и плана до практики и
            контроля готовности. Всё в одном рабочем кабинете.
          </p>
